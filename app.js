\
/**
 * ARK Story Generator (Luxury v1) - v7
...
async function decodeImageFile(file){
  // Robust decode across browsers
  // 1) try createImageBitmap (fast, reliable)
...
els.photo.addEventListener('change', async (e) => {
  ...
  try{
    ...
    showDebug('Could not load image.\n\nDetails: ' + (err && err.message ? err.message : String(err)) + '\n\nTry: a different JPG/PNG, or re-export the photo.');
